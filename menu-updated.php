<?php
session_start();
// This checks if a 'user_id' exists in the session. 
// If it does, $isLoggedIn is true; otherwise, it's false.
...
<body>
    ...
    <header>
        ...
        <nav class="nav-links">
            ...
            <a href="<?php echo $isLoggedIn ? 'reservation.php' : 'login.php'; ?>" >Book Now</a>
        </nav>
        <div class="header-right">
            <span class="phone">+63 993 8818 909</span>
            <a href="<?php echo $isLoggedIn ? 'reservation.php' : 'login.php'; ?>" class="reservation-btn">
                &#128197; Reservation
            </a>
        </div>
    </header>
